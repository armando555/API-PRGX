...
@router.get("/by_country", status_code=status.HTTP_200_OK)
async def by_country(country: str, db: Session = Depends(get_db_connection)):
    return user_repository.get_by_country(db=db, country=country)
